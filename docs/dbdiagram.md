// ============================================
// CLASS ALTER SYSTEM - DATABASE MODEL
// ============================================
...
Enum staff_live_status_enum {
  FREE
  TEACHING
}

Enum alter_status_enum {
  PENDING
  APPROVED
  AUTO_APPROVED
  MODIFIED
...
Table staff_status {
  staff_id uuid [pk]
  current_status staff_live_status_enum [not null]
...
Table alter_requests {
  ...
  status alter_status_enum [not null]
